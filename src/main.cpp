...
// CAN settings
FlexCAN_T4<CAN1, RX_SIZE_256, TX_SIZE_64> Can1; // BMW-E90 side
FlexCAN_T4<CAN2, RX_SIZE_256, TX_SIZE_64> Can2; // VCU side
...
void initCanFilters() {
  ...
  Can2.setMBFilter(MB14,  0x1B5); // Heat flow climate
